...
/*
This code is for arm swivel angle optimization based on muscule activiation given a desired hand(wrist) pose.
This code is for the algorithms proposed in the paper "Muscle-effort-minimization-inspired Kinematic Redundancy Resolution for Replicating Natural Posture of Human Arm" submitted to IEEE Transactions on Neural Systems & Rehabilitation Engineering.
This code is developed by the author Quanlin Li (qlli.hust@gmail.com).
*/
...
public:
    ...
    armSwivelOptimization(std::string& _staticOptimizationSetupXMLFile,   // static optimization setup file for muscle force and acitivation simulation.
                          ...
                          double _localStopCriterion_kappa,  //  local stopping criterion
                          double _globalStopCriterion1_epsilon, // chosen global criterion
