                                             ...
                                             enum globalStopCriterionType _globalStopCriterionSelectionTag)
{
    ...
    globalStopCriterionSelectionTag = _globalStopCriterionSelectionTag;  // which global stop criterion? we choose globalStopCriterion1.
}
...
{
    double iterationStepSize_rho=0.05;  // equal to changing 1 degree in arm swivel angle
