# 1. Aim
To replicate natural human arm posture by performing muscle effort minimization when given a desired hand(wrist) pose. The manuscript has been submitted to IEEE Transactions on Neural Systems and Rehabilitation Engineering and is under review at the moment.
...
3. make
4. ./memikrr ./test/Setup_Analyze.xml ./test/x_arm_musculoskeletal_lql.urdf ./test/x_arm_musculoskeletal_simplified_joints_aligned_lql_noJointOffset.urdf 2.0 0.01 0.1 0.1 2 ./test/wristPoseInput.txt ./result.txt
## 4.1 argument list
